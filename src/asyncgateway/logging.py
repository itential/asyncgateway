...
r"""Comprehensive logging system for asyncgateway.
...
Example:
    Basic usage with console logging::
        ...
        asyncgateway.logging.info("Application started")
        asyncgateway.logging.warning("Configuration file not found, using defaults")
        asyncgateway.logging.error("An error occurred")
    ...
    Function tracing for debugging::
        ...
        asyncgateway.logging.set_level(asyncgateway.logging.TRACE)

        @asyncgateway.logging.trace
    ...
    Fatal errors that exit the application::
        ...
        if critical_error:
            asyncgateway.logging.fatal("Critical failure, cannot continue")
    ...
    Sensitive data filtering::
        ...
        asyncgateway.logging.info("User credentials: api_key=secret123456789012345")
...
from . import heuristics, metadata
...
logging.NONE = logging.FATAL + 10  # type: ignore[attr-defined]
logging.addLevelName(logging.NONE, "NONE")  # type: ignore[attr-defined]
...
FATAL = logging.FATAL  # type: ignore[attr-defined]
...
def _get_loggers() -> set[logging.Logger]:
    ...
    Retrieves loggers that belong to asyncgateway and its dependencies.
...
def get_logger() -> logging.Logger:
    ...
    Returns:
        logging.Logger: The logger instance for asyncgateway.
