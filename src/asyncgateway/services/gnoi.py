...
class Service(ServiceBase):
    ...
    async def clear_interface_counters(self, params: Dict[str, Any]) -> Mapping[str, Any]:
        ...
        res = await self.client.post("/gnoi/clear_interface_counters/execute", json=params)
        return res.json()
    ...
    async def clear_neighbor_discovery(self, params: Dict[str, Any]) -> Mapping[str, Any]:
        ...
        res = await self.client.post("/gnoi/clear_neighbor_discovery/execute", json=params)
        return res.json()
